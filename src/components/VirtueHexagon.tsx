...
export default function VirtueHexagon({ completedVirtues = [], acceptedVirtues = [], onVirtueClick, activeVirtue }: any) {
    ...
    <div className="flex flex-col items-center justify-center">
      ...
      >
        ...
        {PETALS.map((petal) => {
          ...
          const strokeOpacity = isLight ? (isIdle ? 0.75 : 0.9) : (isCompleted ? 1 : isActive ? 1 : isAccepted ? 0.95 : 0.7);
