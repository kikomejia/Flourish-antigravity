  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: theme.bg, color: theme.text }}>
      ...
      <div className="flex flex-col items-center justify-center" style={{ marginTop: "-14px", marginBottom: "-8px" }}>
        ...
        {isViewingToday && (
          <div style={{ height: "52px", overflow: "hidden", marginTop: "-32px" }} className="flex items-center justify-center">
            <AnimatePresence mode="wait">
                  ...
                  {VIRTUES.filter(v => completedVirtues.includes(v.key)).map(v => {
                    ...
                    return (
                      ...
                      >
                        ...
                        />
                        <div>
                          <p className="text-xs font-bold tracking-widest uppercase mb-0.5" style={{ ...getPillStyle(theme, color), display: "inline-block", padding: "1px 8px", borderRadius: "4px" }}>{v.label}</p>
                          {act ? (
                            <>
