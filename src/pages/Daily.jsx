...
export default function Daily() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "#050508", color: "white" }}>
      ...
      {/* Hexagon */}
      <div className="flex flex-col items-center justify-center" style={{ marginTop: "-14px", marginBottom: "-28px" }}>
        <VirtueHexagon
        ...
        {isViewingToday && (
          <div style={{ height: "52px", overflow: "hidden" }} className="flex items-start justify-center pt-3">
            <AnimatePresence mode="wait">
